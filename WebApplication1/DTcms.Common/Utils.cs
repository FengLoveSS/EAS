...
namespace DTcms.Common
{
    public class Utils
    {
        ...
        public static string OutPageList(int pageSize, int pageIndex, int totalCount, string linkUrl, int centSize)
        {
            ...
            //string countstr = "共 " + totalCount.ToString() + " 条记录  ";
            string countstr = "  <span> 共 " + totalCount.ToString() + " 条记录</span>";
            pageStr.Append(countstr);
        ...
        /// < returns>< /returns>
        public static bool CreateList(string url, string fna)
        {
            bool ok;
            //准备生成
            string strHtml;
            ...
            Encoding code = Encoding.UTF8; //定义编码
            //构造web请求，发送请求，获取响应
